<div class="col-3 position-relative" style="margin-top: 10px; margin-bottom: 8px;" >
    ...
    <div class="position-absolute text-white" style="font-size: 13px; font-weight: 700; bottom: 10px; right: @if ($pinBatches[$loop]['balance'] < 10) 18px @else 16px @endif ;">
      {{ '$' . $pinBatches[$loop]['balance'] }}
